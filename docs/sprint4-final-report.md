...
| 类型 | 数量 | 位置 |
|------|------|------|
| Vue 页面组件 | 16 | `apps/frontend-vue/src/pages/` |
| Vue 通用组件 | 12 | `apps/frontend-vue/src/components/` |
| Pinia Store | 4 | `apps/frontend-vue/src/stores/` |
| Composable | 11 | `apps/frontend-vue/src/composables/` |
| API Service | 15 | `apps/frontend-vue/src/services/` (直接复用) |
| 类型定义 | 复用原有 | `apps/frontend-vue/src/types/` (直接复用) |
...
| 前端 - Vue 迁移文档 | `apps/frontend-vue/docs/` |
