...
本文档扫描了 apps/frontend/src/ 中所有模态框组件的交互逻辑，包括触发条件、打开/关闭方式、Props 接口和用户操作回调。

---

## 1. Modal.tsx - 基础模态框组件

**文件位置**：`apps/frontend/src/components/ui/Modal.tsx`
...
**文件位置**：`apps/frontend/src/components/ui/Modal.tsx`（内嵌在 Modal.tsx 中）
...
**文件位置**：`apps/frontend/src/components/modals/CreateFolderModal.tsx`
...
**文件位置**：`apps/frontend/src/components/modals/RenameModal.tsx`
...
**文件位置**：`apps/frontend/src/components/modals/ProjectModal.tsx`
...
**文件位置**：`apps/frontend/src/services/mxcadManager.ts`
...
**文件位置**：`apps/frontend/src/pages/Login.tsx`
