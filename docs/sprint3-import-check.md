...
**检查时间**: 2026-05-02
**检查范围**: `apps/backend/src/` 目录下所有 TypeScript 文件
...
**涉及文件**:
- [public-file.service.ts:L24](file:///d:/project/cloudcad/apps/backend/src/public-file/public-file.service.ts#L24)
- [public-file-upload.service.ts:L27](file:///d:/project/cloudcad/apps/backend/src/public-file/services/public-file-upload.service.ts#L27)
...
**涉及文件**:
- [auth/strategies/jwt.strategy.ts.backup](file:///d:/project/cloudcad/apps/backend/src/auth/strategies/jwt.strategy.ts.backup)
...
**涉及文件**:
- [version-control/version-control.service.ts:L33](file:///d:/project/cloudcad/apps/backend/src/version-control/version-control.service.ts#L33)
- [mxcad/infra/linux-init.service.ts:L28](file:///d:/project/cloudcad/apps/backend/src/mxcad/infra/linux-init.service.ts#L28)
...
| 目录路径 | 状态 |
|---------|------|
| `apps/backend/src/mxcad/conversion/` | ✅ 存在 |
| `apps/backend/src/mxcad/infra/` | ✅ 存在 |
| `apps/backend/src/public-file/` | ✅ 存在 |
| `apps/backend/src/common/services/` | ✅ 存在 |
...
```bash
# 扫描所有 import 语句
grep -rn "^import .* from " apps/backend/src/ --include="*.ts"

# 扫描相对路径导入
grep -rn "from '\.\.\/" apps/backend/src/ --include="*.ts"
```
