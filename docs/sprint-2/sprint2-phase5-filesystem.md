...
| 模块 | 路径 | 状态 | 依赖 |
|------|------|------|------|
| ProjectMemberModule | `apps/backend/src/file-system/project-member/` | ✅ 完成 | FilePermission, AuditLog |
| SearchModule | `apps/backend/src/file-system/search/` | ✅ 完成 | FilePermission |
