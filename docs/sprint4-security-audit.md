...
**审计范围：** `apps/frontend-vue/` 前端构建审计 & `apps/backend/src/` 后端安全审计
...
- `apps/frontend-vue/package.json`
...
- `apps/backend/src/auth/` — 认证相关 Controller、Service、DTO
- `apps/backend/src/file-system/` — 文件系统 Controller、Service
- `apps/backend/src/users/` — 用户管理 Controller
- `apps/backend/src/roles/` — 角色管理 Controller
- `apps/backend/src/public-file/` — 公开文件 Controller
- `apps/backend/src/common/` — 全局 Filter、Guard、Interceptor、Service
- `apps/backend/src/main.ts` — 入口配置
...
**文件：** `apps/backend/src/file-system/search/search.service.ts#L536-548`
...
**文件：** `apps/backend/src/file-system/file-download/file-download-handler.service.ts`
...
**文件：** `apps/backend/src/auth/auth.controller.ts#L736-816`
...
**文件：** `apps/backend/src/main.ts#L151-164`
...
**文件：** `apps/backend/src/file-system/file-system.controller.ts#L777-798`
...
**文件：** `apps/backend/src/file-system/file-system.controller.ts#L348-361`
...
**文件：** `apps/backend/src/file-system/dto/create-project.dto.ts`
...
**文件：** `apps/backend/src/file-system/dto/search.dto.ts`
...
**文件：** `apps/backend/src/main.ts` — Session 配置
...
**文件：** `apps/backend/src/common/filters/exception.filter.ts`
...
**文件：** `apps/backend/src/common/concurrency/rate-limiter.ts`
...
**文件：** `apps/backend/src/auth/services/login.service.ts`
...
**文件：** `apps/backend/src/public-file/public-file.controller.ts#L108-135`
