...
**Status: superseded by ADR-0014** — 2026-07 the decision was reversed: conversion engine is extracted into a standalone function workflow service to support high-concurrency and elastic scaling.
