...
| 序号 | 文件路径 | 类型 | 状态 |
|------|----------|------|------|
| 1 | `apps/backend/src/file-operations/file-operations.service.spec.ts` | 单元测试 | 有结构，TODO 实现 |
| 2 | `apps/backend/src/file-operations/project-crud.service.spec.ts` | 单元测试 | 有结构，TODO 实现 |
| 3 | `apps/backend/src/mxcad/services/file-conversion.service.spec.ts` | 单元测试 | 有结构，TODO 实现 |
| 4 | `apps/backend/src/file-system/file-validation/file-validation.service.spec.ts` | 单元测试 | 有结构，TODO 实现 |
| 5 | `apps/frontend/src/hooks/usePermission.spec.ts` | 单元测试 | **已实现** |
| 6 | `apps/frontend/src/hooks/useExternalReferenceUpload.spec.ts` | 单元测试 | 有结构，TODO 实现 |
| 7 | `apps/frontend/src/hooks/useExternalReferenceUpload.integration.spec.ts` | 集成测试 | 有结构，TODO 实现 |
| 8 | `apps/frontend/src/utils/fileUtils.spec.ts` | 单元测试 | 有结构，TODO 实现 |
...
| 文件路径 | 说明 |
|----------|------|
| `apps/backend/test/app.e2e-spec.ts` | NestJS Supertest 基础端到端测试 |

### 1.3 测试框架配置

| 框架 | 配置文件 | 说明 |
|------|----------|------|
| **Vitest** | `apps/frontend/vitest.config.ts` | Frontend 测试框架，jsdom 环境 |
| **Jest** | `apps/backend/jest.config.ts` | Backend 测试框架，ts-jest 预设 |
