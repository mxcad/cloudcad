...
**文件**: apps/frontend-vue/src/composables/useRegister.ts  
**行数**: 562 行  
**严重程度**: 高  
...
**文件**: apps/frontend-vue/src/composables/useCadEngine.ts  
**行数**: 334 行  
**严重程度**: 高  
...
**文件**: apps/frontend-vue/src/pages/LoginPage.vue  
**严重程度**: 高  
...
**文件**: apps/frontend-vue/src/composables/useUppyUpload.ts  
**位置**: 第 141-187 行  
**严重程度**: 中  
...
**文件**: apps/frontend-vue/src/composables/useAuth.ts  
**位置**: 第 77-79 行  
**严重程度**: 低  
...
**文件**: apps/frontend-vue/src/pages/CadEditorPage.vue  
**位置**: 第 109, 150 行  
**严重程度**: 低  
...
**文件**: apps/frontend-vue/src/stores/auth.store.ts  
**位置**: 第 46-64 行  
**严重程度**: 低  
...
| 序号 | 问题描述 | 文件 | 修复方案 |
|-----|---------|-----|---------|
| 1 | useUppyUpload.ts 中 any 类型滥用 | apps/frontend-vue/src/composables/useUppyUpload.ts | 添加类型接口，替换所有 any |
