...
- [ADR 0001](../../docs/adr/0001-merge-conversion-engine-into-backend.md) — 转换引擎合并决策（已由 ADR-0014 取代 — 2026-07 拆分为独立转换服务）
- [ADR 0014](../../docs/adr/0014-conversion-service.md) — 转换服务（转换引擎独立部署）
- [ADR 0015](../../docs/adr/0015-storage-service-svn-colocated-sharding.md) — 存储服务与 SVN 分片
- [ADR 0016](../../docs/adr/0016-progressive-deployment-three-modes.md) — 三模式渐进部署
