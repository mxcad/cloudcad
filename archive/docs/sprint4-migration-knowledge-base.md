...
**React 源码**: `packages/frontend/src/`
**Vue 迁移版源码**: `packages/frontend-vue/src/`
...
```typescript
// packages/frontend-vue/src/composables/useAuth.ts
...
```typescript
// packages/frontend-vue/src/stores/auth.store.ts
...
```typescript
// packages/frontend-vue/src/stores/ui.store.ts
import { defineStore } from 'pinia';
import { ref } from 'vue';
...
```typescript
// packages/frontend/src/stores/fileSystemStore.ts
import { create } from 'zustand';
...
```typescript
// packages/frontend-vue/src/stores/fileSystem.store.ts (概念示例)
import { defineStore } from 'pinia';
import { ref, computed } from 'vue';
...
```typescript
// packages/frontend-vue/src/composables/usePermission.ts (概念)
...
```typescript
// packages/frontend/src/hooks/useProjectManagement.ts
...
```typescript
// packages/frontend-vue/src/composables/useProjectManagement.ts
import { ref } from 'vue';
...
```vue
// packages/frontend-vue/src/components/ConfirmDialog.vue
<template>
...
```typescript
// packages/frontend-vue/src/composables/useFileSystemUI.ts
...
```vue
// packages/frontend-vue/src/pages/LoginPage.vue
<template>
