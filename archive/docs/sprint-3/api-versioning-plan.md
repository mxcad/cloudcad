...
|----------------|----------|----------|
| FileSystemController | `file-system` | `packages/backend/src/file-system/file-system.controller.ts` |
| MxCadController | `mxcad` | `packages/backend/src/mxcad/core/mxcad.controller.ts` |
| CacheMonitorController | `cache-monitor` | `packages/backend/src/cache-architecture/controllers/cache-monitor.controller.ts` |
| LibraryController | `library` | `packages/backend/src/library/library.controller.ts` |
| UsersController | `users` | `packages/backend/src/users/users.controller.ts` |
| RolesController | `roles` | `packages/backend/src/roles/roles.controller.ts` |
| PublicFileController | `public-file` | `packages/backend/src/public-file/public-file.controller.ts` |
| PolicyConfigController | `policy-config` | `packages/backend/src/policy-engine/controllers/policy-config.controller.ts` |
| AdminController | `admin` | `packages/backend/src/admin/admin.controller.ts` |
| RuntimeConfigController | `runtime-config` | `packages/backend/src/runtime-config/runtime-config.controller.ts` |
| FontsController | `font-management` | `packages/backend/src/fonts/fonts.controller.ts` |
| AuthController | `auth` | `packages/backend/src/auth/auth.controller.ts` |
| AuditLogController | `audit` | `packages/backend/src/audit/audit-log.controller.ts` |
| HealthController | `health` | `packages/backend/src/health/health.controller.ts` |
| VersionControlController | `version-control` | `packages/backend/src/version-control/version-control.controller.ts` |
| UserCleanupController | `user-cleanup` | `packages/backend/src/common/controllers/user-cleanup.controller.ts` |
...
| 文件路径 | 硬编码路径 | 使用场景 |
|----------|-----------|----------|
| `packages/frontend/src/services/filesApi.ts` | `/file-system/nodes/{nodeId}/thumbnail` | 获取文件缩略图 |
| `packages/frontend/src/utils/fileUtils.ts` | `/file-system/nodes/{nodeId}/thumbnail` | 获取缩略图 URL |
| `packages/frontend/src/utils/fileUtils.ts` | `/file-system/nodes/{nodeId}/download` | 下载文件 |
| `packages/frontend/src/services/publicFileApi.ts` | `/public-file/file/check` | 检查文件是否存在 |
| `packages/frontend/src/services/publicFileApi.ts` | `/public-file/chunk/check` | 检查分片是否存在 |
| `packages/frontend/src/services/publicFileApi.ts` | `/public-file/chunk/upload` | 上传分片 |
