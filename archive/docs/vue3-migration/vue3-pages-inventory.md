...
> 生成时间: 2026-05-02
> 目录: `packages/frontend/src/pages/`
...
|------|----------|--------|----------|----------|
| 1 | Register | [Register.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/Register.tsx) | ~1647 | 用户注册页面，支持多种注册方式 |
| 2 | RoleManagement | [RoleManagement.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/RoleManagement.tsx) | ~1369 | 系统角色和项目角色管理 |
| 3 | Profile | [Profile.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/Profile.tsx) | ~1296 | 用户个人资料管理 |
| 4 | FileSystemManager | [FileSystemManager.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/FileSystemManager.tsx) | ~1258 | 文件系统管理，文件和项目管理 |
| 5 | SystemMonitorPage | [SystemMonitorPage.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/SystemMonitorPage.tsx) | ~1185 | 系统监控和存储清理 |
| 6 | LibraryManager | [LibraryManager.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/LibraryManager.tsx) | ~1193 | 公共资源库管理 |
| 7 | RuntimeConfigPage | [RuntimeConfigPage.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/RuntimeConfigPage.tsx) | ~1120 | 运行时配置管理 |
| 8 | Dashboard | [Dashboard.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/Dashboard.tsx) | ~1100+ | 用户仪表盘 |
| 9 | UserManagement | [UserManagement.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/UserManagement.tsx) | ~1000+ | 用户管理 |
| 10 | Login | [Login.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/Login.tsx) | ~900+ | 用户登录页面 |
| 11 | AuditLogPage | [AuditLogPage.tsx](file:///d:/project/cloudcad/packages/frontend/src/pages/AuditLogPage.tsx) | ~539 | 审计日志查看 |
...
**文件路径**: `packages/frontend/src/pages/Register.tsx`
**代码行数**: ~1647 行
...
**文件路径**: `packages/frontend/src/pages/RoleManagement.tsx`
**代码行数**: ~1369 行
...
**文件路径**: `packages/frontend/src/pages/Profile.tsx`
**代码行数**: ~1296 行
...
**文件路径**: `packages/frontend/src/pages/FileSystemManager.tsx`
**代码行数**: ~1258 行
...
**文件路径**: `packages/frontend/src/pages/SystemMonitorPage.tsx`
**代码行数**: ~1185 行
...
**文件路径**: `packages/frontend/src/pages/LibraryManager.tsx`
**代码行数**: ~1193 行
...
**文件路径**: `packages/frontend/src/pages/RuntimeConfigPage.tsx`
**代码行数**: ~1120 行
...
**文件路径**: `packages/frontend/src/pages/Dashboard.tsx`
**代码行数**: ~1100+ 行
...
**文件路径**: `packages/frontend/src/pages/UserManagement.tsx`
**代码行数**: ~1000+ 行
...
**文件路径**: `packages/frontend/src/pages/Login.tsx`
**代码行数**: ~900+ 行
...
**文件路径**: `packages/frontend/src/pages/AuditLogPage.tsx`
**代码行数**: ~539 行
