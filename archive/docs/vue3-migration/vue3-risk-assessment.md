...
**评估范围**: CloudCAD 前端应用 (packages/frontend)
...
**受影响代码**：
```typescript
// packages/frontend/src/hooks/useMxCadEditor.ts
...
// packages/cad-editor/ (React)
// packages/frontend-vue/ (Vue) → iframe 加载 React 应用
```
