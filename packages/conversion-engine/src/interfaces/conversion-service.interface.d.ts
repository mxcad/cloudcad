...
/** DI token：转换引擎配置 */
export declare const CONVERSION_ENGINE_CONFIG: unique symbol;
/** DI token：IConversionService 实现 */
export declare const I_CONVERSION_SERVICE: unique symbol;
//# sourceMappingURL=conversion-service.interface.d.ts.map