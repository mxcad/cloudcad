...
class ApiService {
  ...
  // 文件上传
  async upload<T = any>(url: string, file: File, additionalData?: Record<string, any>): Promise<AxiosResponse<T>> {
...
export const authApi = {
  ...
  register: (data: { email: string; password: string; username: string; nickname?: string }) =>
...
export const usersApi = {
  ...
  create: (data: { email: string; password: string; username: string; nickname?: string; role?: string }) =>
    apiService.post('/users', data),
  
  update: (id: string, data: { email?: string; username?: string; nickname?: string; role?: string; status?: string }) =>
...
export const filesApi = {
  ...
  update: (id: string, data: any) =>
    apiService.patch(`/files/${id}`, data),
  ...
  getAccess: (id: string) =>
    apiService.get(`/files/${id}/access`),
