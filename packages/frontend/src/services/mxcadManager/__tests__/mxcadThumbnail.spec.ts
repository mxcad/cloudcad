...
describe('mxcadThumbnail', () => {
  ...
  describe('checkThumbnail', () => {
    it('returns true when thumbnail exists', async () => {
      const mockCheck = thumbnailControllerCheckThumbnail as ReturnType<
        typeof vi.fn
      >;
  ...
  describe('uploadThumbnail', () => {
    it('uploads thumbnail blob successfully', async () => {
      const mockUpload = thumbnailControllerUploadThumbnail as ReturnType<
        typeof vi.fn
      >;
      ...
      expect(callArgs.body).toEqual({ file: expect.any(File) });
      expect(callArgs.body.file.type).toBe('image/jpeg');
      expect(callArgs.body.file.name).toBe('thumbnail.jpg');
    });
