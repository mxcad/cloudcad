...
export const SidebarTrigger: React.FC<SidebarTriggerProps> = ({
  ...
  return (
    <div
      className={styles.narrowSidebar}
      role="toolbar"
      aria-label={t('侧边栏工具条')}
      data-tour="cad-sidebar-trigger"
    >
      {/* 顶部装饰线 */}
          ...
          <div className={styles.toolWrapper}>
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle, color-mix(in srgb, var(--text-muted) 19%, transparent) 0%, transparent 70%)`,
                }}
              />
            </button>
          </div>
              ...
              <div className={styles.toolWrapper}>
                ...
                >
                  ...
                  <div
                    className={styles.buttonGlow}
                    style={{
                      background: `radial-gradient(circle, ${button.color}30 0%, transparent 70%)`,
                    }}
                  />
                </button>
              </div>
