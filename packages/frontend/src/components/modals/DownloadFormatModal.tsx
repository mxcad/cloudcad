  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* 格式说明 */}
        <div className="space-y-1" style={{ color: 'var(--text-tertiary)' }}>
          <p>
            • <strong>MXWEB</strong>
            {t('：CloudCAD 专用格式，可直接在线编辑')}
          </p>
          <p>
            • <strong>DWG</strong>
            {t('：AutoCAD 原生格式，需要转换时间')}
          </p>
          <p>
            • <strong>DXF</strong>
            {t('：Drawing Exchange Format，需要转换时间')}
          </p>
          <p>
            • <strong>PDF</strong>
            {t('：便携式文档格式，需要转换时间')}
