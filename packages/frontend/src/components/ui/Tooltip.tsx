    ...
    switch (actualPosition) {
      case 'top':
        return {
          ...
          borderColor:
            'var(--bg-tooltip, rgba(30, 41, 59, 0.95)) transparent transparent transparent',
        };
      case 'bottom':
        return {
          ...baseStyles,
          ...
          borderColor:
            'transparent transparent var(--bg-tooltip, rgba(30, 41, 59, 0.95)) transparent',
        };
      case 'left':
        return {
          ...baseStyles,
          ...
          borderColor:
            'transparent transparent transparent var(--bg-tooltip, rgba(30, 41, 59, 0.95))',
        };
      case 'right':
        return {
          ...baseStyles,
          ...
          borderColor:
            'transparent var(--bg-tooltip, rgba(30, 41, 59, 0.95)) transparent transparent',
        };
      default:
        return baseStyles;
    }
