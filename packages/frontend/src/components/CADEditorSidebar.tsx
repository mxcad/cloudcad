...
export const CADEditorSidebar: React.FC<CADEditorSidebarProps> = ({
  ...
  return (
    <div className="h-full flex flex-col" style={{ backgroundColor: 'var(--sidebar-bg, #3A4352)' }}>
      {showHeader && (
        <div
          className="flex"
          style={{
        ...
        >
          <button
            ...
            style={{
              color: galleryType === 'drawings'
                ? 'var(--text-primary, #f0f4f8)'
                : 'var(--text-tertiary, #7a8a99)',
              backgroundColor: galleryType === 'drawings'
                ? 'rgba(255, 255, 255, 0.05)'
                : 'transparent',
              borderBottom: galleryType === 'drawings'
                ? '2px solid var(--primary-500, #818cf8)'
          ...
          <button
            ...
            className="flex-1 py-2 text-sm font-medium transition-all duration-200"
            style={{
              color: galleryType === 'blocks'
                ? 'var(--text-primary, #f0f4f8)'
                : 'var(--text-tertiary, #7a8a99)',
              backgroundColor: galleryType === 'blocks'
                ? 'rgba(255, 255, 255, 0.05)'
                : 'transparent',
              borderBottom: galleryType === 'blocks'
                ? '2px solid var(--primary-500, #818cf8)'
                : '2px solid transparent',
            }}
          >
