 ...
 * 模拟支付回调（仅 mock 模式）
 */
export const billingAdminControllerMockCallback = <ThrowOnError extends boolean = false>(options: Options<BillingAdminControllerMockCallbackData, ThrowOnError>) => (options.client ?? client).post<BillingAdminControllerMockCallbackResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
