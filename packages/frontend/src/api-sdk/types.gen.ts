...
export type NodePropertiesPermissionsDto = {
    /**
     * 是否可编辑
     */
    canEdit: boolean;
...
export type FileSystemControllerGetNodePropertiesData = {
    body?: never;
    path: {
        nodeId: string;
    };
...
export type FileSystemControllerGetNodePropertiesErrors = {
    /**
     * 节点不存在
     */
    404: unknown;
...
export type FileSystemControllerGetNodePropertiesResponses = {
    /**
     * 节点属性信息
     */
    200: NodePropertiesDto;
};

export type FileSystemControllerGetNodePropertiesResponse = FileSystemControllerGetNodePropertiesResponses[keyof FileSystemControllerGetNodePropertiesResponses];
