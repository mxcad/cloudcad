...
declare namespace Paths {
    ...
    namespace FileSystemControllerGetDeletedProjects {
        namespace Parameters {
            export type Filter = "all" | "owned" | "joined";
            export type Limit = number;
            export type Page = number;
