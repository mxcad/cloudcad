...
export const SupportModal: React.FC<SupportModalProps> = ({ onClose }) => {
  return (
    <Modal isOpen onClose={onClose} title="账号已被禁用">
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-sm">
            <span style={{ color: 'var(--text-tertiary)' }}>客服邮箱：</span>
            <a href="mailto:support@cloudcad.com" className="hover:underline" style={{ color: 'var(--primary-500)' }}>
              support@cloudcad.com
            </a>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span style={{ color: 'var(--text-tertiary)' }}>客服电话：</span>
            <a href="tel:400-123-4567" className="hover:underline" style={{ color: 'var(--primary-500)' }}>
              400-123-4567
            </a>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <span style={{ color: 'var(--text-tertiary)' }}>工作时间：</span>
            <span style={{ color: 'var(--text-secondary)' }}>周一至周五 9:00-18:00</span>
          </div>
        </div>
      </div>
    </Modal>
