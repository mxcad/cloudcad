...
export const projectManagementFullGuide: TourGuide = {
  ...
  steps: [
    ...
    },
    {
      ...
      title: '创建协同',
      content: '在当前图纸面板中点击「创建协同」，为当前图纸创建一个协同会话。',
      placement: 'bottom',
      mode: 'interactive',
      actionType: 'click',
      actionHint: '请点击「创建协同」按钮',
      highlight: true,
      waitForElement: 3000,
      fallbackContent: '「创建协同」按钮在协同面板的当前图纸标签页中。',
    },
    {
      target: 'join-collaborate-btn',
      title: '加入协同',
      content: '创建成功后，在当前图纸面板中点击「加入协同」即可实时协作编辑。其他人加入后，大家可以一起实时协同编辑同一张图纸。',
      placement: 'left',
      mode: 'interactive',
      actionType: 'click',
      actionHint: '请点击「加入协同」按钮',
      highlight: true,
      waitForElement: 2000,
      fallbackContent: '「加入协同」按钮显示在协同面板的当前图纸标签页中。',
    },
  ],
};
