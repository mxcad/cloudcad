...
describe('CAD External Reference Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        externalRefService = moduleFixture.get(ExternalRefService);
        externalReferenceUpdateService = moduleFixture.get(ExternalReferenceUpdateService);
        externalReferenceHandler = moduleFixture.get(ExternalReferenceHandler);
        ...
        fs.writeFileSync(path.join(fileDir, `${testFileId}.dwg.mxweb_preloading.json`), JSON.stringify(preloadingData));
...
//# sourceMappingURL=cad-external-ref.integration.spec.js.map