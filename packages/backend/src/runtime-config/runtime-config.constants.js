...
export const RUNTIME_CONFIG_DEFINITIONS = [
    ...
    },
    {
        ...
        type: 'boolean',
        category: 'wechat',
        description: '微信登录自动创建账号（开启后无需填写用户名密码，类似手机验证码登录）',
        defaultValue: false,
        isPublic: true,
    },
    // 存储配额配置（单位：GB）
 ...
 * 默认配置值映射
 */
export const DEFAULT_RUNTIME_CONFIGS = Object.fromEntries(RUNTIME_CONFIG_DEFINITIONS.map((def) => [def.key, def.defaultValue]));
//# sourceMappingURL=runtime-config.constants.js.map