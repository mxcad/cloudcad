...
let FileConversionService = (() => {
    ...
    var FileConversionService = _classThis = class {
        constructor(configService, processRunner) {
        ...
        async executeConversion(options) {
            ...
            try {
                ...
                const result = await this.processRunner.run(this.mxCadAssemblyPath, runOpts);
                ...
                if (outputToCheck) {
                    try {
                        ...
                        const outputStr = typeof outputToCheck === "string"
                            ? outputToCheck
