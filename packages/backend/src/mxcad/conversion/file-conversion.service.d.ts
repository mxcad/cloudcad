...
import type { ConversionOptions, ConversionResult, IFileConversionService } from "../interfaces/file-conversion.interface";
export declare class FileConversionService implements IFileConversionService {
    ...
    constructor(configService: ConfigService, processRunner: ProcessRunnerService);
    /**
     * 将路径解析为绝对路径
