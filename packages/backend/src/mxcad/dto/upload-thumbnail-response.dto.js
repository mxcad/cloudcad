...
export { UploadThumbnailDataDto };
/**
 * 上传缩略图响应 DTO
 */
let UploadThumbnailResponseDto = (() => {
    var _a;
    ...
    return _a = class UploadThumbnailResponseDto {
            constructor() {
...
export { UploadThumbnailResponseDto };
//# sourceMappingURL=upload-thumbnail-response.dto.js.map