...
let FileExistResponseDto = (() => {
    ...
    return _a = class FileExistResponseDto {
            constructor() {
                this.exists = __runInitializers(this, _exists_initializers, void 0);
                this.nodeId = (__runInitializers(this, _exists_extraInitializers), __runInitializers(this, _nodeId_initializers, void 0));
                __runInitializers(this, _nodeId_extraInitializers);
            }
        },
        (() => {
...
export { FileExistResponseDto };
//# sourceMappingURL=file-exist-response.dto.js.map