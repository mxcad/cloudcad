...
import { findThumbnail, getThumbnailFileName, THUMBNAIL_FORMATS } from './services/thumbnail-utils';
let MxCadService = (() => {
    ...
    var MxCadService = _classThis = class {
         ...
         * @returns 保存结果
         */
        async saveMxwebFile(nodeId, file, userId, userName, commitMessage, skipBinGeneration = false) {
            try {
