 ...
 * 上传阶段枚举
 */
export type UploadStage = 'initializing' | 'checking' | 'uploading' | 'merging' | 'converting' | 'finalizing' | 'failed' | 'completed';
/**
 * 取消令牌接口
 * 用于取消正在进行的上传操作
 */
...
//# sourceMappingURL=upload-options.interface.d.ts.map