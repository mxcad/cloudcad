...
import { UploadChunkOptions, MergeOptions, MergeResult } from '../upload/file-upload-manager.types';
...
export class ChunkUploadManagerService {
  ...
  async checkChunkExist(options: UploadChunkOptions): Promise<{ ret: MxUploadReturn }> {
  ...
  async uploadChunk(options: UploadChunkOptions): Promise<{ ret: MxUploadReturn; tz?: boolean }> {
