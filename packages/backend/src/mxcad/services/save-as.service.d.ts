...
export declare class SaveAsService {
    ...
    constructor(fileSystemServiceMain: MainFileSystemService, fileSystemNodeService: FileSystemNodeService, storageManager: StorageManager, fileConversionService: FileConversionService, permissionService: FileSystemPermissionService, versionControlService: VersionControlService, prisma: DatabaseService);
