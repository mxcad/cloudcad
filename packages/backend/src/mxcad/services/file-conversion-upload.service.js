...
let FileConversionUploadService = (() => {
    ...
    var FileConversionUploadService = _classThis = class {
        constructor(configService, fileSystemService, fileSystemServiceMain, fileSystemNodeService, cacheManager, storageManager, versionControlService, fileConversionService, externalReferenceUpdateService, externalRefService, uploadUtilityService, fileMergeService, thumbnailGenerationService) {
