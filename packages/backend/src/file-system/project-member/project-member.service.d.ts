...
export declare class ProjectMemberService {
    ...
    constructor(prisma: DatabaseService, permissionService: FileSystemPermissionService, projectPermissionService: ProjectPermissionService, auditLogService: AuditLogService);
