...
describe("FileTreeService", () => {
    ...
    beforeEach(async () => {
        ...
        service = module.get(FileTreeService);
    });
    // ==================== createFileNode ====================
    describe("createFileNode", () => {
        ...
        it("should throw NotFoundException when parent not found", async () => {
            ...
            await expect(service.createFileNode(defaultOptions)).rejects.toThrow(NotFoundException);
        });
        it("should throw BadRequestException when parent is not a folder", async () => {
            ...
            await expect(service.createFileNode(defaultOptions)).rejects.toThrow(BadRequestException);
        });
    ...
    describe("getNodeWithLibraryKey", () => {
        ...
        it("should throw when not found", async () => {
            mockPrisma.fileSystemNode.findUnique.mockResolvedValue(null);
            await expect(service.getNodeWithLibraryKey("missing")).rejects.toThrow(NotFoundException);
        });
    });
    // ==================== isLibraryNode ====================
    ...
    describe("getNodeTree", () => {
        ...
        it("should throw when not found", async () => {
            mockPrisma.fileSystemNode.findUnique.mockResolvedValue(null);
            await expect(service.getNodeTree("missing")).rejects.toThrow(NotFoundException);
        });
    });
    // ==================== getChildren ====================
    describe("getChildren", () => {
        ...
        it("should filter by nodeType", async () => {
            ...
            expect(mockPrisma.fileSystemNode.findMany.mock.calls[0][0].where.isFolder).toBe(true);
        });
    });
    // ==================== updateNodePath ====================
    ...
    describe("getRootNode", () => {
        ...
        it("should throw NotFoundException when no root found", async () => {
            ...
            await expect(service.getRootNode("orphan")).rejects.toThrow(NotFoundException);
        });
    });
    // ==================== getProjectId ====================
...
//# sourceMappingURL=file-tree.service.spec.js.map