...
export declare class FileDownloadExportService {
    ...
    constructor(prisma: DatabaseService, storage: LocalStorageProvider, storageManager: StorageManager, configService: ConfigService, permissionService: FileSystemPermissionService, moduleRef: ModuleRef);
