...
export declare class ProjectCrudService {
    ...
    constructor(prisma: DatabaseService, storageManager: StorageManager, permissionService: FileSystemPermissionService, personalSpaceService: PersonalSpaceService, fileOperationsService: FileOperationsService, fileTreeService: FileTreeService);
