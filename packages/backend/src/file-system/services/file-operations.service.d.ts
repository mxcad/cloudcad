...
export declare class FileOperationsService {
    ...
    constructor(prisma: DatabaseService, storageManager: StorageManager, configService: ConfigService, versionControlService: VersionControlService, storageInfoService: StorageInfoService, fileTreeService: FileTreeService);
    ...
    deleteFileIfNotReferenced(tx: Prisma.TransactionClient, nodePath: string, fileHash: string | null): Promise<void>;
    ...
    restoreTrashItems(itemIds: string[]): Promise<{
        message: string;
    }>;
