...
let MoveNodeDto = (() => {
    ...
    return _a = class MoveNodeDto {
            constructor() {
                this.targetParentId = __runInitializers(this, _targetParentId_initializers, void 0);
                __runInitializers(this, _targetParentId_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _targetParentId_decorators = [ApiProperty({ description: '目标父节点ID' }), IsString()];
...
export { MoveNodeDto };
//# sourceMappingURL=move-node.dto.js.map