...
let CreateNodeDto = (() => {
    ...
    return _a = class CreateNodeDto {
        ...
        (() => {
            ...
            _name_decorators = [ApiProperty({ description: '节点名称', example: '设计图纸' }), IsString(), Length(1, 100)];
            _description_decorators = [ApiProperty({ description: '节点描述', required: false }), IsOptional(), IsString(), Length(0, 500)];
