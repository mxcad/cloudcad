...
describe('ProjectPermissionService', () => {
  ...
  describe('getUserPermissions', () => {
    ...
    it('should return all project permissions for personal space owner', async () => {
      ...
      const result = await service.getUserPermissions('user1', 'ps1');
  ...
  describe('getUserRole', () => {
    ...
    it('should return OWNER for personal space owner', async () => {
      ...
      const result = await service.getUserRole('user1', 'ps1');
  ...
  describe('checkAnyPermission', () => {
    ...
    it('should return false when user has none of the permissions', async () => {
      mockPrisma.projectMember.findUnique.mockResolvedValue({
        projectRole: {
          permissions: [{ permission: ProjectPermission.FILE_OPEN }],
        },
      });
