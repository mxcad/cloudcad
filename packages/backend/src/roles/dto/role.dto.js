...
let RoleDto = (() => {
    ...
    return _a = class RoleDto {
            constructor() {
                ...
                this.isSystem = (__runInitializers(this, _level_extraInitializers), __runInitializers(this, _isSystem_initializers, void 0));
                this.permissions = (__runInitializers(this, _isSystem_extraInitializers), __runInitializers(this, _permissions_initializers, void 0));
        ...
        (() => {
            ...
            _category_decorators = [ApiProperty({
                    ...
                    enumName: 'RoleCategoryEnum',
                })];
            _level_decorators = [ApiProperty({ description: '角色级别（用于权限继承）' })];
            _isSystem_decorators = [ApiProperty({ description: '是否为系统角色（不可删除）' })];
...
let ProjectRolePermissionDto = (() => {
    ...
    let _createdAt_initializers = [];
    let _createdAt_extraInitializers = [];
    return _a = class ProjectRolePermissionDto {
            constructor() {
                this.id = __runInitializers(this, _id_initializers, void 0);
                this.projectRoleId = (__runInitializers(this, _id_extraInitializers), __runInitializers(this, _projectRoleId_initializers, void 0));
                this.permission = (__runInitializers(this, _projectRoleId_extraInitializers), __runInitializers(this, _permission_initializers, void 0));
                this.createdAt = (__runInitializers(this, _permission_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
                __runInitializers(this, _createdAt_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [ApiProperty({ description: '权限 ID' })];
...
export { ProjectRolePermissionDto };
/**
 * 项目角色 DTO
 */
let ProjectRoleDto = (() => {
    ...
    let _updatedAt_initializers = [];
    let _updatedAt_extraInitializers = [];
    return _a = class ProjectRoleDto {
            constructor() {
                this.id = __runInitializers(this, _id_initializers, void 0);
                ...
                this.permissions = (__runInitializers(this, _isSystem_extraInitializers), __runInitializers(this, _permissions_initializers, void 0));
                this._count = (__runInitializers(this, _permissions_extraInitializers), __runInitializers(this, __count_initializers, void 0));
                this.project = (__runInitializers(this, __count_extraInitializers), __runInitializers(this, _project_initializers, void 0));
                this.createdAt = (__runInitializers(this, _project_extraInitializers), __runInitializers(this, _createdAt_initializers, void 0));
                this.updatedAt = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _updatedAt_initializers, void 0));
                __runInitializers(this, _updatedAt_extraInitializers);
            }
        },
        (() => {
            ...
            _permissions_decorators = [ApiProperty({
                    description: '权限列表',
                    type: () => [ProjectRolePermissionDto],
                })];
            __count_decorators = [ApiProperty({ description: '成员数量', required: false })];
            _project_decorators = [ApiProperty({ description: '关联的项目', required: false })];
            _createdAt_decorators = [ApiProperty({ description: '创建时间' })];
            _updatedAt_decorators = [ApiProperty({ description: '更新时间' })];
            __esDecorate(null, null, _id_decorators, { kind: "field", name: "id", static: false, private: false, access: { has: obj => "id" in obj, get: obj => obj.id, set: (obj, value) => { obj.id = value; } }, metadata: _metadata }, _id_initializers, _id_extraInitializers);
