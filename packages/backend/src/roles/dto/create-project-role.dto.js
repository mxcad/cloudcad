...
let CreateProjectRoleDto = (() => {
    ...
    return _a = class CreateProjectRoleDto {
            constructor() {
        ...
        (() => {
            ...
            _name_decorators = [ApiProperty({ description: '角色名称', example: '项目经理' }), IsString(), IsNotEmpty()];
...
export { CreateProjectRoleDto };
//# sourceMappingURL=create-project-role.dto.js.map