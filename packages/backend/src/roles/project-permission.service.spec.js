...
describe('ProjectPermissionService', () => {
    ...
    const mockPermissionStore = {
        ...
        getUserProjectPermissions: jest.fn().mockResolvedValue([]),
    ...
    beforeEach(async () => {
        ...
        service = module.get(ProjectPermissionService);
    });
    ...
    describe('checkPermission', () => {
        it('should return cached permission value when available', async () => {
            ...
            const result = await service.checkPermission('user1', 'project1', ProjectPermission.PROJECT_UPDATE);
        ...
        it('should return false when permission not found', async () => {
            ...
            const result = await service.checkPermission('user1', 'project1', ProjectPermission.PROJECT_DELETE);
    ...
    describe('clearUserCache', () => {
        it('should clear all relevant cache keys', async () => {
            ...
            expect(mockCacheService.delete).toHaveBeenCalledWith('project:owner:user1:project1');
            expect(mockCacheService.delete).toHaveBeenCalledWith('project:role:user1:project1');
        });
    });
...
//# sourceMappingURL=project-permission.service.spec.js.map