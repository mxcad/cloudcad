...
describe('ProjectRolesService', () => {
    ...
    describe('create', () => {
        it('should create a new project role', async () => {
            ...
            expect(mockPrisma.projectRole.create).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('remove', () => {
        ...
        it('should throw BadRequestException when deleting system role', async () => {
            ...
            mockPrisma.projectRole.findUnique.mockResolvedValue(existingRole);
            mockPrisma.projectRolePermission.findMany.mockResolvedValue([{ permission: "PROJECT_UPDATE" }]);
            await expect(service.delete('role1')).rejects.toThrow(BadRequestException);
        });
    ...
    describe('addPermissions', () => {
        it('should add permissions to role', async () => {
            ...
            expect(mockPrisma.projectRole.update).toHaveBeenCalledWith(expect.objectContaining({
                where: { id: 'role1' },
                data: expect.objectContaining({
...
//# sourceMappingURL=project-roles.service.spec.js.map