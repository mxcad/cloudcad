...
export const SYSTEM_ROLE_PERMISSIONS: Record<SystemRole, SystemPermission[]> = {
  [SystemRole.ADMIN]: [
    // 系统管理员拥有所有系统权限
    PrismaPermission.USER_READ,
    PrismaPermission.USER_CREATE,
    PrismaPermission.USER_UPDATE,
    PrismaPermission.USER_DELETE,
    PrismaPermission.ROLE_READ,
    PrismaPermission.ROLE_CREATE,
    PrismaPermission.ROLE_UPDATE,
    PrismaPermission.ROLE_DELETE,
    PrismaPermission.ROLE_PERMISSION_MANAGE,
    PrismaPermission.FONT_READ,
    PrismaPermission.FONT_UPLOAD,
    PrismaPermission.FONT_DELETE,
    PrismaPermission.FONT_DOWNLOAD,
...
> = {
  [ProjectRole.OWNER]: [
    ...
    PrismaProjectPermission.PROJECT_SETTINGS_MANAGE,
    ...
    PrismaProjectPermission.FILE_COMMENT,
    ...
    PrismaProjectPermission.VERSION_DELETE,
    PrismaProjectPermission.VERSION_RESTORE,
  ],
  [ProjectRole.ADMIN]: [
    // 项目管理员权限
    PrismaProjectPermission.PROJECT_READ,
