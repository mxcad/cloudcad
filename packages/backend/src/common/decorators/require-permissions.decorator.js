 ...
 * 权限检查模式
 */
export var PermissionCheckMode;
 ...
 */
export const RequirePermissions = (permissions, mode = PermissionCheckMode.ALL) => {
    return applyDecorators(SetMetadata(PERMISSIONS_KEY, permissions), SetMetadata(PERMISSIONS_MODE_KEY, mode));
};
