import type { LoginDto, RegisterDto, AuthResponseDto, UserDto } from '../dto/auth.dto';
import type { WechatLoginResponseDto } from '../dto/wechat.dto';
import type { SessionRequest } from './jwt-payload.interface';
...
// ==================== Root Interface (extends all sub-interfaces) ====================
