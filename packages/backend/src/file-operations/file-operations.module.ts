...
import { NodeUpdateService, NodeNameService, NodeTrashService, NodeCopyMoveService } from './file-operations.service';
 ...
 * 依赖: FileTreeModule, StorageQuotaModule
 */
@Module({
  imports: [
    DatabaseModule,
  ...
  providers: [NodeUpdateService, NodeTrashService, NodeCopyMoveService, NodeNameService, ProjectCrudService, NodeMutationGuard, NodeStatusTransitioner],
  exports: [NodeUpdateService, NodeTrashService, NodeCopyMoveService, NodeNameService, ProjectCrudService, NodeMutationGuard, NodeStatusTransitioner],
})
