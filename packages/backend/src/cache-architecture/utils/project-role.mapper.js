...
export class ProjectRoleMapper {
     ...
     * @returns 项目访问角色
     */
    static mapRoleToAccessRole(roleName) {
     ...
     * @returns 角色名称数组
     */
    static getAvailableDatabaseRoles() {
     ...
     * @returns 项目访问角色数组
     */
    static getAvailableAccessRoles() {
     ...
     * @returns 是否存在
     */
    static hasDatabaseRole(roleName) {
...
//# sourceMappingURL=project-role.mapper.js.map