...
// Use the DATABASE_URL from the environment or default to the one in .env
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres:password@localhost:5432/cloudcad';

// Initialize Prisma Client directly with the database URL
...
async function main() {
  try {
    ...
    for (const lib of libraries) {
      ...
      const nodeType = lib.key === 'drawing' ? 'LIBRARY_DRAWING' : 'LIBRARY_BLOCK';
