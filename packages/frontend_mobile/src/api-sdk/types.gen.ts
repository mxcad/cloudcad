...
export type CreateRoleDto = {
     ...
     * 权限列表（数据库存储格式：大写）
     */
    permissions: Array<'SYSTEM_USER_READ' | 'SYSTEM_USER_CREATE' | 'SYSTEM_USER_UPDATE' | 'SYSTEM_USER_DELETE' | 'SYSTEM_ROLE_READ' | 'SYSTEM_ROLE_CREATE' | 'SYSTEM_ROLE_UPDATE' | 'SYSTEM_ROLE_DELETE' | 'SYSTEM_ROLE_PERMISSION_MANAGE' | 'SYSTEM_FONT_READ' | 'SYSTEM_FONT_UPLOAD' | 'SYSTEM_FONT_DELETE' | 'SYSTEM_FONT_DOWNLOAD' | 'SYSTEM_ADMIN' | 'SYSTEM_BILLING_READ' | 'SYSTEM_BILLING_WRITE' | 'SYSTEM_MONITOR' | 'SYSTEM_CONFIG_READ' | 'SYSTEM_CONFIG_WRITE' | 'LIBRARY_DRAWING_MANAGE' | 'LIBRARY_BLOCK_MANAGE' | 'STORAGE_QUOTA' | 'PROJECT_CREATE'>;
};
 ...
 * 系统权限枚举
 */
export type SystemPermission = 'SYSTEM_USER_READ' | 'SYSTEM_USER_CREATE' | 'SYSTEM_USER_UPDATE' | 'SYSTEM_USER_DELETE' | 'SYSTEM_ROLE_READ' | 'SYSTEM_ROLE_CREATE' | 'SYSTEM_ROLE_UPDATE' | 'SYSTEM_ROLE_DELETE' | 'SYSTEM_ROLE_PERMISSION_MANAGE' | 'SYSTEM_FONT_READ' | 'SYSTEM_FONT_UPLOAD' | 'SYSTEM_FONT_DELETE' | 'SYSTEM_FONT_DOWNLOAD' | 'SYSTEM_ADMIN' | 'SYSTEM_BILLING_READ' | 'SYSTEM_BILLING_WRITE' | 'SYSTEM_MONITOR' | 'SYSTEM_CONFIG_READ' | 'SYSTEM_CONFIG_WRITE' | 'LIBRARY_DRAWING_MANAGE' | 'LIBRARY_BLOCK_MANAGE' | 'STORAGE_QUOTA' | 'PROJECT_CREATE';
 ...
 * 统一权限枚举
 */
export type Permission = 'SYSTEM_USER_READ' | 'SYSTEM_USER_CREATE' | 'SYSTEM_USER_UPDATE' | 'SYSTEM_USER_DELETE' | 'SYSTEM_ROLE_READ' | 'SYSTEM_ROLE_CREATE' | 'SYSTEM_ROLE_UPDATE' | 'SYSTEM_ROLE_DELETE' | 'SYSTEM_ROLE_PERMISSION_MANAGE' | 'SYSTEM_FONT_READ' | 'SYSTEM_FONT_UPLOAD' | 'SYSTEM_FONT_DELETE' | 'SYSTEM_FONT_DOWNLOAD' | 'SYSTEM_ADMIN' | 'SYSTEM_BILLING_READ' | 'SYSTEM_BILLING_WRITE' | 'SYSTEM_MONITOR' | 'SYSTEM_CONFIG_READ' | 'SYSTEM_CONFIG_WRITE' | 'LIBRARY_DRAWING_MANAGE' | 'LIBRARY_BLOCK_MANAGE' | 'STORAGE_QUOTA' | 'PROJECT_CREATE' | 'PROJECT_UPDATE' | 'PROJECT_DELETE' | 'PROJECT_MEMBER_MANAGE' | 'PROJECT_MEMBER_ASSIGN' | 'PROJECT_TRANSFER' | 'PROJECT_ROLE_MANAGE' | 'PROJECT_ROLE_PERMISSION_MANAGE' | 'FILE_CREATE' | 'FILE_UPLOAD' | 'FILE_OPEN' | 'FILE_EDIT' | 'FILE_DELETE' | 'FILE_TRASH_MANAGE' | 'FILE_DOWNLOAD' | 'FILE_SHARE' | 'FILE_MOVE' | 'FILE_COPY' | 'CAD_SAVE' | 'CAD_EXTERNAL_REFERENCE' | 'VERSION_READ';
