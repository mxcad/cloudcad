 ...
 * 创建新图纸（从空白模板）
 */
export const fileSystemControllerCreateDrawing = <ThrowOnError extends boolean = false>(options: Options<FileSystemControllerCreateDrawingData, ThrowOnError>) => (options.client ?? client).post<FileSystemControllerCreateDrawingResponses, FileSystemControllerCreateDrawingErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const fileSystemControllerGetParentContext = <ThrowOnError extends boolean = false>(options: Options<FileSystemControllerGetParentContextData, ThrowOnError>) => (options.client ?? client).get<FileSystemControllerGetParentContextResponses, FileSystemControllerGetParentContextErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 批量删除节点
 */
export const fileSystemControllerBatchDeleteNodes = <ThrowOnError extends boolean = false>(options: Options<FileSystemControllerBatchDeleteNodesData, ThrowOnError>) => (options.client ?? client).post<FileSystemControllerBatchDeleteNodesResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 批量移动节点
 */
export const fileSystemControllerBatchMoveNodes = <ThrowOnError extends boolean = false>(options: Options<FileSystemControllerBatchMoveNodesData, ThrowOnError>) => (options.client ?? client).post<FileSystemControllerBatchMoveNodesResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 批量复制节点
 */
export const fileSystemControllerBatchCopyNodes = <ThrowOnError extends boolean = false>(options: Options<FileSystemControllerBatchCopyNodesData, ThrowOnError>) => (options.client ?? client).post<FileSystemControllerBatchCopyNodesResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const fileSystemControllerResolvePath = <ThrowOnError extends boolean = false>(options: Options<FileSystemControllerResolvePathData, ThrowOnError>) => (options.client ?? client).get<FileSystemControllerResolvePathResponses, FileSystemControllerResolvePathErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 套餐列表
 */
export const billingControllerGetPlans = <ThrowOnError extends boolean = false>(options?: Options<BillingControllerGetPlansData, ThrowOnError>) => (options?.client ?? client).get<BillingControllerGetPlansResponses, unknown, ThrowOnError>({ url: '/api/v1/billing/plans', ...options });
 ...
 * 所有套餐（含已下架）
 */
export const billingAdminControllerGetAllPlans = <ThrowOnError extends boolean = false>(options?: Options<BillingAdminControllerGetAllPlansData, ThrowOnError>) => (options?.client ?? client).get<BillingAdminControllerGetAllPlansResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 新增套餐
 */
export const billingAdminControllerCreatePlan = <ThrowOnError extends boolean = false>(options: Options<BillingAdminControllerCreatePlanData, ThrowOnError>) => (options.client ?? client).post<BillingAdminControllerCreatePlanResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/admin/billing/plans',
    ...options,
    headers: {
 ...
 * 下架套餐
 */
export const billingAdminControllerDeactivatePlan = <ThrowOnError extends boolean = false>(options: Options<BillingAdminControllerDeactivatePlanData, ThrowOnError>) => (options.client ?? client).delete<BillingAdminControllerDeactivatePlanResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * 修改套餐
 */
export const billingAdminControllerUpdatePlan = <ThrowOnError extends boolean = false>(options: Options<BillingAdminControllerUpdatePlanData, ThrowOnError>) => (options.client ?? client).put<BillingAdminControllerUpdatePlanResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/api/v1/admin/billing/plans/{id}',
    ...options,
    headers: {
