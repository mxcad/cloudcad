 ...
 * 获取文件已有的分享链接列表
 */
export const cooperateControllerGetFileShares = <ThrowOnError extends boolean = false>(options: Options<CooperateControllerGetFileSharesData, ThrowOnError>) => (options.client ?? client).get<CooperateControllerGetFileSharesResponses, unknown, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
