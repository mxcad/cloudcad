  ...
  const checkPermission = useCallback(
    async (projectId: string, permission: string): Promise<boolean> => {
      ...
      try {
        ...
        console.error('检查项目权限失败:', 'useProjectPermission');
  ...
  const getPermissions = useCallback(
    async (projectId: string): Promise<string[]> => {
      ...
      try {
        ...
        console.error('获取项目权限失败:', 'useProjectPermission');
        return [];
      }
    },
    []
  ...
  const getRole = useCallback(
    async (projectId: string): Promise<string | null> => {
      ...
      try {
        ...
        console.error('获取项目角色失败:', 'useProjectPermission');
        return null;
      }
    },
    []
  ...
  const forceCheckPermission = useCallback(
    async (projectId: string, permission: string): Promise<boolean> => {
      ...
      try {
        ...
        console.error('强制检查项目权限失败:', 'useProjectPermission');
        return false;
      }
    },
    []
