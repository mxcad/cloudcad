...
│   │   │   │   ├── ExternalReferenceModal.tsx
│   │   │   │   ├── MembersModal.tsx
│   │   │   │   ├── ProjectModal.tsx
│   │   │   │   ├── RenameModal.tsx
│   │   │   │   └── SelectFolderModal.tsx
│   │   │   ├── ui/              # UI 基础组件
...
### 16.1 前端测试（Vitest + Testing Library）
...
_v5.3 | 2026-01-12 | CloudCAD 团队_
_更新：项目架构优化、回收站功能、外部参照上传增强、开发环境配置优化、测试环境更新、新增数据验证库_