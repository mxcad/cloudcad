...
| 权限类别       | 权限列表                                                                 |
| -------------- | ------------------------------------------------------------------------ |
| 项目管理权限   | PROJECT_CREATE, PROJECT_READ, PROJECT_UPDATE, PROJECT_DELETE, PROJECT_MEMBER_MANAGE, PROJECT_MEMBER_ASSIGN, PROJECT_ROLE_MANAGE, PROJECT_ROLE_PERMISSION_MANAGE, PROJECT_TRANSFER, PROJECT_SETTINGS_MANAGE |
...
| 组件/服务                    | 路径                                               |
| --------------------------- | -------------------------------------------------- |
| PermissionCacheService      | `packages/backend/src/common/services/`            |
| RolesCacheService           | `packages/backend/src/common/services/`            |
| RedisCacheService           | `packages/backend/src/common/services/`            |
| CacheWarmupService          | `packages/backend/src/common/services/`            |
| CacheCleanupScheduler       | `packages/backend/src/common/schedulers/`          |
| CacheMonitorController      | `packages/backend/src/common/controllers/`         |
...
_v6.2 | 2026-01-29 | CloudCAD 团队_
_更新：缓存系统文档、技术栈更新、功能完善_